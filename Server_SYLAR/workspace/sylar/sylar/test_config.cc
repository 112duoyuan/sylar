...
sylar::ConfigVar<std::vector<int>>::ptr g_int_vec_value_config = 
    sylar::Config::Lokkup("system.int_vec",std::vector<int>(1,2),"system int vec");
sylar::ConfigVar<std::list<int>>::ptr g_int_list_value_config = 
    sylar::Config::Lokkup("system.int_list",std::list<int>(1,2),"system int list");
sylar::ConfigVar<std::set<int>>::ptr g_int_set_value_config = 
    sylar::Config::Lokkup("system.int_set",std::set<int>(1,2),"system int set");
sylar::ConfigVar<std::unordered_set<int>>::ptr g_int_uset_value_config = 
    sylar::Config::Lokkup("system.int_uset",unordered_set<int>(1,2),"system int uset");
sylar::ConfigVar<std::map<std::string,int>>::ptr g_str_int_map_value_config = 
    sylar::Config::Lokkup("system.str_int_map",std::map<std::string,int>{{"k",2}},"system string int map");
sylar::ConfigVar<std::unordered_map<std::string,int>>::ptr g_str_int_umap_value_config = 
    sylar::Config::Lokkup("system.str_int_umap",std::unordered_map<std::string,int>{{"k",2}},"system string int umap");
