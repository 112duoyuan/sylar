...
#define XX(type,len,write_fun,read_fun,base_len) {\ 
    ...
    XX(int16_t,100,writeFuint16,readFint16,1);
    XX(uint16_t,100,writeFuint16,readFuint16,1);
    
    XX(int32_t,100,writeuInt32,readInt32,1);
    XX(uint32_t,100,writeUint32,readUint32,1);
    XX(int64_t,100,writeuInt64,readInt64,1);
...
#define XX(type,len,write_fun,read_fun,base_len) {\ 
    ...
    SYLAR_ASSERT(ba->readFromFile("/tmp/" #type "_" #len "-" #read_fun ".dat"));\
    ba2->setPosition(0); \
